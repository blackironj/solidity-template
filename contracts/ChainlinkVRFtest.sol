...
contract ChainlinkVRFtest is ERC721, ERC721URIStorage, VRFConsumerBaseV2 {
    ...
    constructor(uint64 _subscriptionId, address _vrfCoordinator) ERC721("ChainlinkVRFtest", "ONC") VRFConsumerBaseV2(_vrfCoordinator) {
